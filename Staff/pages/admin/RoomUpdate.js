...
export default function AdminRoomUpdate() {
  ...
  const loadRoom = async () => {
    try {
      const { data } = await axios.get(`/room/${params.slug}`);
      setName(data.name);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      photo && roomData.append("photo", photo);
      ...
      const { data } = await axios.put(`/room/${id}`, roomData);
      if (data?.error) {
      ...
      console.log(err);
      toast.error("room create failed. Try again.");
    }
  };
      ...
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-md-9">
            <div className="p-3 mt-2 mb-2 h4 bg-light">Update Room</div>
            ...
            {photo ? (
              ...
              <div className="text-center">
                <img
                  ...
                  }/room/photo/${id}?${new Date().getTime()}`}
                  alt="room photo"
                  className="img img-responsive"
                  height="200px"
                />
