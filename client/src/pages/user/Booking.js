...
export default function UserBooking(){
    ...
    const handleSubmit =async (e) => {
        ...
        const {data} = await axios.post("/category", {name});
            ...
            console.log(err);
            toast.error("Create Room category failed. Try again.");
           ...
           const handleupdate = async (e) => {
            ...
            e.preventDefault();
             ...
             try{
                ...
                console.log(err);
                toast.error("Room Category may already exist");
             }
           }; 
    ...
    return(
        ...
        />
                 ...
                 <div className="p-3 mt-2 mb-2 h4 bg-light">Manage Room Categories</div>
